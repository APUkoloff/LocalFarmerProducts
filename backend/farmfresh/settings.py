...
if DB_ENGINE == 'sqlite':
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'fresh_market'),
            'USER': os.getenv('DB_USER', 'fresh_user'),
            'PASSWORD': os.getenv('DB_PASSWORD', 'fresh_pass'),
...
DEFAULT_FROM_EMAIL = 'noreply@freshmarket.local'
